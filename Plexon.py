...
class Plexon():
    ...
    try:
        ...
        PL_GetLongWaveFormStructuresEx2 = _lib.PL_GetWaveFormStructuresEx2
        PL_GetLongWaveFormStructuresEx2.argtypes = [ctypes.POINTER(ctypes.c_int), ctypes.POINTER(PL_Wave), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
        PL_GetLongWaveFormStructuresEx2.restype = None
